...
| fix  | app/ — cancelar la captura ya no quema el permiso de MediaProjection + el segundo pedido vuelve a mostrar el diálogo | ✅ Completo (PR pendiente — actualizar con #N al abrir) |
