...
| F    | app/ — recortes/notas: la captura crea su propio tipo de contenido en vez de una historia | ✅ Completo (PR pendiente — actualizar con #N al abrir; smoke en `docs/smoke-recortes.md` SIN CORRER todavía) |
